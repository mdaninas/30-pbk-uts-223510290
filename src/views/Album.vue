<template>
        ...
        <q-dialog v-model="dialog" persistent :maximized="maximizedToggle" transition-show="slide-up"
            ...
            <q-card class="bg-primary text-white">
                ...
                <div class="popdesk">
                    ...
                    <div class="isidesk">
                        <p class="vv" v-if="selectedPhoto">{{ selectedPhoto.title }}</p>
                    </div>
                </div>
            </q-card>
        </q-dialog>
    ...
    <div class="galwrap">
        <div class="galwrap1">
            <span v-if="page">
                <div class="row">
                    <div class="col zz zf">Nomor
                    </div>
                    <div class="col zz zf">Judul</div>
                    <div class="col zz zf" style="padding-left: 300px;">IdAlbum</div>
                </div>
            ...
            <div v-else>
                <div v-if="selectedAlbumId" class="photo-list">
                    <div class="photos">
                        <h3 class="zz">Photos in Album {{ selectedAlbumId }}</h3>
                        <button @click="backalbum" class="backal">Back To Album </button>
                    </div>
                    <div class="photov">
                        <h2 class="zzc">Foto</h2>
                        <h2 class="zzc">Judul Foto</h2>
                    </div>
